...
//         {/* The below Routes donot require login*/}
...
//         {/*  The below routes require login  */}
...
// // It is made to make sure that only admin can access those routes*/}

// <Route element = {<ProtectedRoute isAuthenticated = {true} adminOnly = {true} admin={user?.role==="admin"?true:false}  />}>


//   // Remember we are using route tag as wrapper 
...
const App = () => {
  ...
  return loading ? (
    ...
    <Router>
      ...
      <Suspense fallback={<Loader />}>
        <Routes>
          {/* The below Routes do not require login */}
          <Route path="/" element={<Home />} />
          <Route path="/search" element={<Search />} />
          <Route path="/cart" element={<Cart />} />
